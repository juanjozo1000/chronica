  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Capture and mint historical moments as NFTs"
        />
      </Head>
        ...
        <Card elevation={8} sx={{ borderRadius: 3 }}>
          ...
          <CardContent sx={{ p: 3 }}>
            ...
            {locationPermission === "denied" && (
              ...
              >
                Location access denied. Media will be saved without location
                data.
              </Alert>
            )}
            ...
            {mode === "form" && (
              <Stack spacing={3}>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setMediaData((prev) => ({ ...prev, title: e.target.value }))
                  }
                  required
                />
